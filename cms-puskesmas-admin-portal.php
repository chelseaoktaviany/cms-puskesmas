...
<html lang="en">
    ...
    <head>
        ...
        <title>CMS Puskesmas - Admin Portal</title>
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <?php echo "<h6 class='m-0 font-weight-bold text-primary'>" . "Welcome, " . $_SESSION['username']. "!" . " Semoga harimu yang menyenangkan!" . "</h6>";?>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                                ...
                                                <div class="col">
                                                    <div>
                                                        <p style="text-align:justify;">
                                                            Pusat Kesehatan Masyarakat atau Puskesmas adalah salah satu sarana pelayanan kesehatan masyarakat yang amat
                                                            penting di Indonesia. Puskesmas adalah unit pelaksana teknis dinas kabupaten/kota yang bertanggungjawab menyelenggarakan pembangunan
