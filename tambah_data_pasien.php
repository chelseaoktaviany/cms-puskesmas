...
<html lang="en">
    ...
    <head>
        ...
        <title>CMS Puskesmas - Tambah Data Pasien</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">                           
                                        <form role="form" action="action_tambah_pasien.php" method="POST">
                                            <div class="form-group">
                                                <label>Kode Pasien</label>
                                                <input type="text" name="pasien_id" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nama Pasien</label>
                                                <input type="text" name="nama_p" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Jenis Kelamin</label>
                                                <div class="form-check" required>
                                                    <input class="form-check-input" type="radio" name="jenisk_pasien" class="form-control" value="L">
                                                    <label class="form-check-label">L</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="jenisk_pasien" class="form-control" value="P">
                                                    <label class="form-check-label">P</label>
                                                </div>                                         
                                            </div>
                                            <div class="form-group">
                                                <label>Golongan Darah</label>
                                                <input type="text" name="gol_d_pasien" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal Lahir</label>
                                                <input type="date" name="tgll_pasien" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <textarea rows="2" name="alamat_pasien" class="form-control" required></textarea>
                                            </div>
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-success">Tambah</button>
                                                <a class="btn btn-default" href="data_pasien.php" role="button">Kembali</a>
                                            </div>                          
                                        </form>
                                    </div>
