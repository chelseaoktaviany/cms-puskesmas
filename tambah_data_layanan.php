...
<html lang="en">
    ...
    <head>
        ...
        <title>CMS Puskesmas - Tambah Data Layanan</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">                           
                                        <form role="form" action="action_tambah_layanan.php" method="POST">
                                            <div class="form-group">
                                                <label>Kode Layanan</label>
                                                <input type="text" name="layanan_id" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Jenis Layanan</label>
                                                <input type="text" name="jenis_l" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Tarif Layanan</label>
                                                <input type="text" name="tar_lay" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group text-center">
                                                ...
                                                <a class="btn btn-default" href="data_layanan.php" role="button">Kembali</a>
                                            </div>                          
                                        </form>
                                    </div>
