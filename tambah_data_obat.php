...
<html lang="en">
    ...
    <head>
        ...
        <title>CMS Puskesmas - Tambah Data Obat</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">                           
                                        <form role="form" action="action_tambah_obat.php" method="POST">
                                            <div class="form-group">
                                                <label>Kode Obat</label>
                                                <input type="text" name="obat_id" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nama Obat</label>
                                                <input type="text" name="nama_o" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Harga</label>
                                                <input type="text" name="harga_o" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Deskripsi</label>
                                                <textarea rows="3" name="desk_o" class="form-control" required></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Satuan</label>
                                                <input type="text" name="satuan_o" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-success">Tambah</button>
                                                <a class="btn btn-default" href="data_obat.php" role="button">Kembali</a>
                                            </div>                          
                                        </form>
                                    </div>
