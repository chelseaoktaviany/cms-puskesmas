...
<html lang="en">
    ...
    <head>
        ...
        <title>CMS Puskesmas - Tambah Data Kamar</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">                           
                                        <form role="form" action="action_tambah_kamar.php" method="POST">
                                            <div class="form-group">
                                                <label>Kode Kamar</label>
                                                <input type="text" name="kamar_id" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Jenis Kamar</label>
                                                <input type="text" name="jenis_kam" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Tarif Per Malam</label>
                                                <input type="text" name="tarif_perm" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Fasilitas</label>
                                                <input type="text" name="fasilitas_kam" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-success">Tambah</button>
                                                <a class="btn btn-default" href="data_kamar.php" role="button">Kembali</a>
                                            </div>                          
                                        </form>
                                    </div>
