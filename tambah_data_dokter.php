...
<html lang="en">
    ...
    <head>
        ...
        <title>CMS Puskesmas - Tambah Data Dokter</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">                           
                                        <form role="form" action="action_tambah_dokter.php" method="POST">
                                            <div class="form-group">
                                                <label>Kode Dokter</label>
                                                <input type="text" name="dokter_id" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nama Dokter</label>
                                                <input type="text" name="nama_d" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group" required>
                                                <label>Jenis Kelamin</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="jenisk_dokter" class="form-control" value="L">
                                                    <label class="form-check-label">L</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="jenisk_dokter" class="form-control" value="P">
                                                    <label class="form-check-label">P</label>
                                                </div>                                         
                                            </div>
                                            <div class="form-group">
                                                <label>Telepon</label>
                                                <input type="tel" name="tel_dok" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <input type="text" name="alamat_dok" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Keahlian</label>
                                                <input type="text" name="keahlian_dok" class="form-control" value="" required>
                                            </div>
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-success">Tambah</button>
                                                <a class="btn btn-default" href="data_dokter.php" role="button">Kembali</a>
                                            </div>                          
                                        </form>
                                    </div>
